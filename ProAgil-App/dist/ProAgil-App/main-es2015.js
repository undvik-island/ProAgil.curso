...
function EventosComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Local: ", evento_r1.local, " ");
} }
class EventosComponent {
    ...
    getEventos() {
        this.http.get('http://localhost:5000/v1/values').subscribe(response => {
...
EventosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventosComponent, selectors: [["app-eventos"]], decls: 3, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function EventosComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, EventosComponent_div_2_Template, 5, 2, "div", 0);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
module.exports = __webpack_require__(/*! C:\Users\igoru\Source\.NETCore e Angular\ProAgil-App\src\main.ts */"./src/main.ts");
