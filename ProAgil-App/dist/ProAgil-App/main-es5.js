...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppEventosEventosComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EventosComponent_tr_23_Template(rf, ctx) {
      if (rf & 1) {
    ...
    EventosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 24,
      vars: 1,
      consts: [[1, "form-inline"], [1, "form-group", "mb-2"], ["type", "text", "placeholder", "buscar", 1, "form-control", "mr-2"], [1, "btn", "btn-outline-success"], [1, "table", "table-striped"], [1, "thead-dark"], [4, "ngFor", "ngForOf"]],
      template: function EventosComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](21, "Op\xE7\xF5es");
